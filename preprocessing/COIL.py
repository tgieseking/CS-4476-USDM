...
np.save("COIL_X_seed", X_seed)
np.save("COIL_X_active", X_active)
np.save("COIL_X_test", X_test_scaled)
np.save("COIL_y_seed", y_seed)
np.save("COIL_y_active", y_active)
np.save("COIL_y_test", y_test)
